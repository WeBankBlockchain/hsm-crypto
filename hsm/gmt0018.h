...
#define SGD_3DES_ECB_GDCA		0x00002001
#define SGD_3DES_CBC_GDCA		0x00002002
#define SGD_AES_ECB_GDCA		0x00004001
#define SGD_AES_CBC_GDCA		0x00004002
#define SGD_SMS4_ECB_GDCA		0x00000401
#define SGD_SMS4_CBC_GDCA		0x00000402
...
#define SWR_LOGIN_ERR           (SWR_CARD_BASE + 0x00001011)
...
SGD_RV SDF_InternalPublicKeyOperation_RSA_Ex(SGD_HANDLE hSessionHandle,SGD_UINT32  uiKeyIndex,SGD_UINT32 uiAlgID,SGD_UCHAR *pucDataInput,SGD_UINT32  uiInputLength,SGD_UCHAR *pucDataOutput,SGD_UINT32  *puiOutputLength);
SGD_RV SDF_InternalPrivateKeyOperation_RSA_Ex(SGD_HANDLE hSessionHandle,SGD_UINT32  uiKeyIndex,SGD_UINT32 uiAlgID,SGD_UCHAR *pucDataInput,SGD_UINT32  uiInputLength,SGD_UCHAR *pucDataOutput,SGD_UINT32  *puiOutputLength);
